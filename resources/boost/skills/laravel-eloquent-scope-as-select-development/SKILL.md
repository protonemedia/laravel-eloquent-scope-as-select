...
## Overview
Use `protonemedia/laravel-eloquent-scope-as-select.` in a Laravel application.
...
- Activate when code references `protonemedia/laravel-eloquent-scope-as-select.` classes, facades, config, or documented features.
